...
>>>>>>> upstream/main
    ...
    if (!isAdmin) {
        if (!this.__user) {
<<<<<<< HEAD
            throw new SkapiError("User needs to login.", {
                code: "INVALID_REQUEST",
            });
        }

        if (this.__user.access_group !== 99) {
            throw new SkapiError("Invalid access.", {
                code: "INVALID_REQUEST",
            });
        }
    }
        ...
        access_group: (v: number) => {
            ...
            try {
                ...
                throw new SkapiError(
                    '"access_group" is invalid. Should be type <number>.',
                    { code: "INVALID_PARAMETER" }
                );
            }
            if (typeof v !== "number" || v < 1 || v > 100) {
                throw new SkapiError(
                    '"access_group" is invalid. Should be type <number> of range 1~99',
                    { code: "INVALID_PARAMETER" }
                );
            }
            return v;
...
<<<<<<< HEAD
            if (typeof v === "string") {
                ...
                throw new SkapiError(
                    '"options.confirmation_url" should be type: <string>.',
                    { code: "INVALID_PARAMETER" }
                );
            }
            ...
            if (value && !params.email) {
                throw new SkapiError(
                    '"email" is required for signup confirmation.',
                    { code: "INVALID_PARAMETER" }
                );
=======
            if (typeof v === 'string') {
...
<<<<<<< HEAD
            if (typeof v !== "boolean") {
                throw new SkapiError(
                    '"options.email_subscription" should be type: <boolean>.',
                    { code: "INVALID_PARAMETER" }
                );
            }
            if (!options?.confirmation_url) {
                ...
                throw new SkapiError(
                    '"options.confirmation_url" is required for email subscription.',
                    { code: "INVALID_PARAMETER" }
                );
            }
            return v;
...
<<<<<<< HEAD
        UserAttributes &
            UserProfilePublicSettings & { email: string; password: string } & {
                service?: string;
                owner?: string;
            }
    >
...
<<<<<<< HEAD
    let params = validator.Params(form, paramRestrictions, [
        "email",
        "password",
    ]);
=======
...
<<<<<<< HEAD
    ...
    let resp = await request.bind(this)(
        "invitation-list",
        Object.assign({ mode: "search" }, params),
        { fetchOptions, auth: true }
    );
=======
            throw new SkapiError('User needs to login.', { code: 'INVALID_REQUEST' });
        }
...
<<<<<<< HEAD
    ...
    return await request.bind(this)(
        "invitation-list",
        Object.assign({ mode: "cancel" }, params),
        { auth: true }
    );
}
...
<<<<<<< HEAD
    ...
    return await request.bind(this)(
        "invitation-list",
        Object.assign({ mode: "resend" }, params),
        { auth: true }
    );
}
=======
